...
function abrirprimeraseccion (event) {
    ...
    elemento_1.classList.remove ("oculto");
    ...
    elemento_abrir1.addEventListener ("click", cerrarprimerseccion);
function cerrarprimerseccion() {
  event.preventDefault();
...
function abrirsegundaseccion (event) {
    event.preventDefault();
    elemento_2.classList.remove ("oculto");
    ...
    elemento_abrir2.addEventListener ("click", cerrarsegundaseccion);
function cerrarsegundaseccion() {
  event.preventDefault();
...
function abrirterceraseccion (event) {
    event.preventDefault();
    elemento_3.classList.remove ("oculto");
    ...
    elemento_abrir3.addEventListener ("click", cerrarterceraseccion);
function cerrarterceraseccion() {
  event.preventDefault();
...
function abrircuartaseccion (event) {
    event.preventDefault();
    elemento_4.classList.remove ("oculto");
    ...
    elemento_abrir4.addEventListener ("click", cerrarcuartaseccion);
function cerrarcuartaseccion() {
  event.preventDefault();
...
function abrirquinaseccion (event) {
    event.preventDefault();
    elemento_5.classList.remove ("oculto");
    ...
    elemento_abrir5.addEventListener ("click", cerrarquintaseccion);
function cerrarquintaseccion() {
  event.preventDefault();
...
function abrirsextaseccion (event) {
    event.preventDefault();
    elemento_6.classList.remove ("oculto");
    ...
    elemento_abrir6.addEventListener ("click", cerrarsextaseccion);
function cerrarsextaseccion() {
  event.preventDefault();
...
function abrirseptimaseccion (event) {
    event.preventDefault();
    elemento_7.classList.remove ("oculto");
    ...
    elemento_abrir7.addEventListener ("click", cerrarseptimaseccion);
function cerrarseptimaseccion() {
  event.preventDefault();
  if (elemento_7.style.display === "none") {
    elemento_7.style.display = "block";
  } else {
    elemento_7.style.display = "none";
  }
